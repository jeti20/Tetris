//Skrypt tworzy odowiednie kszta³ty kolcków

using System.Collections.Generic;
using UnityEngine;


public static class Data //static data we can access from whatever. We cannot crate here instances 
{
    ...
    {
        { Tetromino.I /*Key*/, new Vector2Int[] { new Vector2Int(-1, 1), new Vector2Int( 0, 1), new Vector2Int( 1, 1), new Vector2Int( 2, 1) } /*value*/},
